...
export type DeliverableType = 'brand-voice-guide' | 'social-post' | 'carousel-caption' | 'landing-page-copy' | 'email-sequence' | 'ad-copy' | 'video-script' | 'hashtag-set' | 'quality-evaluator';
